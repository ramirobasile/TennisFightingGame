				...
				new Attack[] {
					...
					new Attack(startup: 0.2f, endlag: 0.3f, 
						...
						hitboxes: new Hitbox[] {
							new Hitbox(rectangle: new Rectangle(90, -5, 100, 75),
								start: 0, duration: 0.4f,
								force: new Vector2(2000, -300),
								//gravityScalar: new Polynomial(new float[] { 4, -2, 1 }),
								hitLag: 0.5f, hitStun: 0.5f,
					...
					new Attack(startup: 0.2f, endlag: 0.3f, 
						...
						hitboxes: new Hitbox[] {
							new Hitbox(rectangle: new Rectangle(90, -5, 100, 75),
								start: 0, duration: 0.4f,
								force: new Vector2(2000, 0),
								//gravityScalar: new Polynomial(new float[] { 3, -3/2, 4/5 }),
								hitLag: 0.5f, hitStun: 0.5f,
								onAddedSounds: new SoundEffect[][] { swingSounds, wizardGrunts },
								onHitSounds: strongHitSounds)
							}),
					...
					new Attack(startup: 0.2f, endlag: 0.3f, 
						...
						hitboxes: new Hitbox[] {
							new Hitbox(rectangle: new Rectangle(90, -5, 100, 75),
								start: 0, duration: 0.4f,
								force: new Vector2(2000, -300),
								//gravityScalar: new Polynomial(new float[] {1, 1, 1, -1/2 }),
								hitLag: 0.5f, hitStun: 0.5f,
								onAddedSounds: new SoundEffect[][] { swingSounds, wizardGrunts },
								onHitSounds: strongHitSounds)
							}),
