			...
			Player.Character jorgito = new Player.Character("Jorgito",
				...
				new Attack[] {
					...
					new Attack(startup: .075f, endlag: .05f, 
						...
						staminaCost: 5,
						hitboxes: new Hitbox[] {
							new Hitbox(rect: new Rectangle(65, 40, 100, 40),
					...
					new Attack(startup: .09f, endlag: .15f, 
						...
						hitboxes: new Hitbox[] {
							new Hitbox(rect: new Rectangle(30, 5, 65, 65),
							...
							new Hitbox(rect: new Rectangle(90, 15, 55, 55),
					...
					new Attack(startup: 0.2f, endlag: 0.3f, 
						...
						hitboxes: new Hitbox[] {
							...
							new Hitbox(rect: new Rectangle(75, -20, 60, 60),
					...
					new Attack(startup: .05f, endlag: .075f, 
						...
						staminaCost: 6,
						hitboxes: new Hitbox[] {
							new Hitbox(rect: new Rectangle(15, -40, 60, 60),
								start: 0, duration: 0.09f,
								force: new Vector2(325, -950),
								hitStun: 0.05f, hitLag: 0.05f, shakeMagnitude: 2,
								onHitSounds: weakHitSounds,
								onAddedSounds: new SoundEffect[][] { swingSounds }),
							new Hitbox(rect: new Rectangle(30, 10, 60, 60),
								start: 0.09f, duration: 0.09f,
								force: new Vector2(325, -950),
								hitStun: 0.05f, hitLag: 0.05f, shakeMagnitude: 2,
								onHitSounds: weakHitSounds),
							new Hitbox(rect: new Rectangle(15, 50, 60, 60),
					...
					new Attack(startup: 0, endlag: 0.05f, 
						...
						multiHit: true,
						hitboxes: new Hitbox[] {
							new Hitbox(rect: new Rectangle(0, 0, 100, 100),
								start: 0, duration: 0.5f,
								force: new Vector2(0, -1400)),
							new Hitbox(rect: new Rectangle(0, -50, 100, 100),
					...
					new Attack(startup: 0, endlag: 0.5f, 
						...
						hitboxes: new Hitbox[]  {
							new Hitbox(rect: new Rectangle(0, 0, 100, 100),
								...
								force: new Vector2(0, -1400)),
							new Hitbox(rect: new Rectangle(0, -90, 100, 100),
			...
			Player.Character chino = new Player.Character(
				...
				new Attack[] {
	                ...
	                new Attack(startup: 0.065f, endlag: 0.2f, 
						...
						softHitCancel: true,
						hitboxes: new Hitbox[] {
							new Hitbox(rect: new Rectangle(30, 0, 80, 80),
	                ...
	                new Attack(startup: 0.275f, endlag: 0.3f,
						...
						onStartupSounds: new SoundEffect[][] { chinoLoudGrunts },
						hitboxes: new Hitbox[] {
							new Hitbox(rect: new Rectangle(60, 0, 120, 45),
								...
								onHitSounds: weakHitSounds,
								onAddedSounds: new SoundEffect[][] { swingSounds }),
							new Hitbox(rect: new Rectangle(60, 20, 120, 35),
	                ...
	                new Attack(startup: 0, endlag: 0.45f, 
						...
						hitboxes: new Hitbox[] {
			                new Hitbox(rect: new Rectangle(0, 0, 100, 100),
				                start: 0, duration: 0.05f,
				                force: new Vector2(0, -1400)),
			                new Hitbox(rect: new Rectangle(30, 0, 150, 45),
				                start: 1, duration: .2f,
			...
			Player.Character monkey = new Player.Character(
				...
				new Attack[] {
	                ...
	                new Attack(startup: 0.05f, endlag: 0.25f, 
						...
						hitboxes: new Hitbox[] {
							new Hitbox(rect: new Rectangle(-10, -110, 50, 80),
								start: 0, duration: 0.4f,
					...
					new Attack(startup: 0.15f, endlag: 0.075f, 
						...
						onStartupSounds: new SoundEffect[][] { monkeyGrunts }, 
						hitboxes: new Hitbox[] {
							new Hitbox(rect: new Rectangle(40, 5, 120, 50),
