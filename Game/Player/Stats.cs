namespace TennisFightingGame
{
	...
	public struct Stats
	{
		...
		public readonly float sprintStaminaCost;
		public readonly float sprintingJumpSpeed;
		...
		public Stats(float gravity, float friction, float sprintSpeed, float sprintStaminaCost,
			float sprintingJumpSpeed, float walkSpeed, float walkStaminaCost, float jumpSpeed, 
			...
			float enduranceDegen, float jumpSquat, float exhaustedJumpSquat, float turnDelay)
		{
			...
			this.sprintingJumpSpeed = sprintingJumpSpeed;
